                    ...
                    {holdings.length > 0 &&
                        holdings.map((holding, index) => {
                            return (
                                <div
                                    key={index}
                                    className="flex flex-col gap-2 border bg-neutral-800 border-neutral-950  rounded-lg p-3 mt-2 shadow-lg hover:bg-neutral-700 cursor-pointer"
                                    onClick={() => {
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-3 gap-2 ">
                                        ...
                                        <div className="text-center">{numeral(holding.current_value).format("0,0.00")}</div>
                                        ...
                                        <div className={`text-center ${holding.xirr >= 0 ? "text-green-500" : "text-red-500"}`}>
