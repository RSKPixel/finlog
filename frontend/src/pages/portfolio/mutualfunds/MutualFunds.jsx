        ...
        <div className="flex flex-col gap-4 w-full items-center">
            <div className="flex flex-col w-full items-center">
                <div className="w-full px-2 text-sm font-bold z-10 border border-sky-900 py-1 rounded-t-sm bg-sky-950 flex flex-row items-center">
                    ...
                    {assetClasses && (
                        <span className="text-xs ms-2 text-gray-400">
                ...
                <div className="grid grid-cols-2 gap-2 items-center border border-t-0 bg-stone-900 rounded-b-sm w-full p-1.5 border-sky-900">
                    {loading && (
                        ...
                        holdings.map((holding, index) => {
                            return (
                                <div key={index} className="flex flex-col gap-2 border bg-neutral-800 border-neutral-950  rounded-lg py-2 px-4 mt-2 shadow-lg hover:bg-neutral-700 cursor-pointer">
                                    <div className="text-sm font-bold text-nowrap overflow-hidden text-ellipsis">{holding.instrument_name}</div>
